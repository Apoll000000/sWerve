                        ...
                        <Table>
                            ...
                            <TableBody>
                                {services.map((service) => (
                                    <TableRow key={service.service_id}>
                                        <TableCell>{service.thumbnail}</TableCell>
                                        <TableCell>{service.service_title}</TableCell>
                                        <TableCell className="font-medium">{service.service_id}</TableCell>
                                        <TableCell>{service.activeStatus}</TableCell>
                                        <TableCell>{service.totalSales}</TableCell>
                            ...
                            <TableFooter>
                                <TableRow>
                                    ...
                                    <TableCell className="text-right">Php60,000.00</TableCell>
                                </TableRow>
                            </TableFooter>
                        </Table>
                    </div>
